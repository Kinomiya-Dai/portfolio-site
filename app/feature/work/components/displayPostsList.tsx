              ...
              .map((post) => (
                ...
                >
                  <article className="border border-transparent rounded-[5px] overflow-hidden  shadow-xl/30 shadow-pf-text transition-transform hover:-translate-y-4 duration-500">
                    ...
                    <div className="relative h-40 flex flex-col md:flex-row space-x-0 p-4 text-pf-text bg-pf-bg">
                      <div className="flex flex-col">
                        <p className="font-bold dark:text-neutral-100 tracking-tight mb-2">
                          {post.metadata.title}
                        </p>
                        <p className="text-[12px] ">{post.metadata.summary}</p>
                      </div>
